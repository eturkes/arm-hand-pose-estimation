...
- Both call sites print the **requested** device rather than `compiled_model.get_property("EXECUTION_DEVICES")` — truthful only while exact device names are passed (`.agent/polish.md`).
