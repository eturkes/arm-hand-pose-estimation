...
- `prototype/review-ui/` — **PROTOTYPE target, unbuilt.** One local web UI, three views: corpus
  census · clip player with pose overlay · cohort-stats explorer. Run command + `proof/` land
  with the artifact.
